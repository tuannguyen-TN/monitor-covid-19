...
def vietnam():
    while True:
        a = "Up-to-date Covid-19 Statistics in Vietnam:\n"
        print("Up-to-date Covid-19 Statistics in Vietnam:")
        ...
        # Fetch data from api
        req = requests.get('https://coronavirus-19-api.herokuapp.com/countries/vietnam')
        data = req.json()
